...
render_completed_orders_section = _render_completed_orders_section
render_completed_kpis_display = _render_completed_kpis_display
...
__all__.extend([
    ...
    "render_completed_orders_section",
    "render_completed_kpis_display",
])
